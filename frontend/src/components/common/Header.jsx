      ...
      <div className="rc-GlobalPageHeaderContainer css-1ch79bo" style={{}}>
        <nav data-testid="page-header-wrapper" data-e2e="page-header" className="css-1pf5qcx">
          <div className="css-o6cx9a">
            ...
            {/* Main Header - Sticky below black nav */}
            <div className="css-1l23jbm">
              <header className="bg-white border-b border-neutral-border sticky top-0 lg:top-[40px] z-40">
                <div className="max-w-coursera mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="hidden lg:flex flex-1 max-w-md mx-8">
                    <form onSubmit={handleSearch} className="w-full relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-10 py-2 border border-neutral-border rounded-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm"
